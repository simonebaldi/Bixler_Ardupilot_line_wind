...
% Selector
Guid.Strategy = 1;                      % 1 for SL, 0 for Orbit
Guid.Method = 1;                        % 0=APF, 1=Standard, 2=Ideal
...
Guid.Loiter.C = [125 75];               % Orbt center [m] 
                                        % (only of pathmanager not active)
Guid.Loiter.j = -1;                      % Clockwise-counterclockwise
                                        % (only of pathmanager not active)
